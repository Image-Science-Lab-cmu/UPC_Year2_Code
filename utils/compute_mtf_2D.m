function [mtf_x, mtf_y, mtf_z, mtf_radial_avg, mtf_radial_min] = compute_mtf_2D(psf)
...
mtf_radial_avg = zeros(1, ceil(w/2));
mtf_radial_min = zeros(1, ceil(w/2));
for dist = 0: ceil(w/2)-1
